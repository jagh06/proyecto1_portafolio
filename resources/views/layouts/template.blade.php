...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <!-- Masthead-->
        <header class="masthead  text-white text-center" style="background-color:rgb(236, 210, 63)">
            <div class="container d-flex align-items-center flex-column">
                <!-- Masthead Avatar Image-->
                <!-- <img class="masthead-avatar mb-5" src="assets/img/avataaars.svg" alt="..." /> -->
                <img class="masthead-avatar mb-5" src="assets/img/user.png" alt="..." />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Juan Guzmán hernandez</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Universitario-Programador Backend</p>
            </div>
        </header>
        <!-- Portfolio Section-->
...
>>>>>>> main
        ...
        <footer class="footer text-center">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Footer About Text-->
                    <div class="col-lg-4">
                        <h4 class="text-uppercase mb-4">Sobre guzman.com</h4>
                        <p class="lead mb-0">
                            guzman.com es una pagina dedicada a ...
                            <a href="http://startbootstrap.com">Start guzman.com</a>
                            .
                        </p>
                    </div>
                </div>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Copyright &copy; guzmangh.com 2022</small></div>
        </div>
        <!-- Portfolio Modals-->
